...
SetTimeSlotViewData_t SetTimeSlotPresenter_GetData(SetTimeSlotPresenter_t *presenter);
void SetTimeSlotPresenter_SetData(SetTimeSlotPresenter_t *presenter, const SetTimeSlotViewData_t *data);
