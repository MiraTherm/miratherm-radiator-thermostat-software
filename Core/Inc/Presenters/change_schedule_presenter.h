...
#include "storage_task.h" /* For ConfigModel_t */
#include <stdbool.h>
...
ChangeSchedulePresenter_t* ChangeSchedulePresenter_Init(ChangeScheduleView_t *view, ConfigModel_t *config_access, bool skip_confirmation);
