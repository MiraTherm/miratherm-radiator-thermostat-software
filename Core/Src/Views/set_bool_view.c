...
SetBoolView_t* SetBoolView_Init(const char *title, const char *option_true, const char *option_false, bool show_back_hint)
{
    ...
    lv_label_set_text(view->label_step_caption, title ? title : "Set value:");
    ...
    /* Radio button style */
    lv_obj_set_style_radius(view->checkbox_false, LV_RADIUS_CIRCLE, LV_PART_INDICATOR);
    ...
    lv_obj_set_style_border_color(view->checkbox_false, lv_color_white(), LV_PART_INDICATOR);
    lv_obj_set_style_border_width(view->checkbox_false, 1, LV_PART_INDICATOR);
    lv_obj_set_style_bg_color(view->checkbox_false, lv_color_black(), LV_PART_INDICATOR);
    lv_obj_set_style_bg_opa(view->checkbox_false, LV_OPA_COVER, LV_PART_INDICATOR);
    
    /* Checked: White background, Black checkmark */
    lv_obj_set_style_bg_color(view->checkbox_false, lv_color_white(), LV_PART_INDICATOR | LV_STATE_CHECKED);
    lv_obj_set_style_text_color(view->checkbox_false, lv_color_black(), LV_PART_INDICATOR | LV_STATE_CHECKED);
    ...
    /* Radio button style */
    lv_obj_set_style_radius(view->checkbox_true, LV_RADIUS_CIRCLE, LV_PART_INDICATOR);
    ...
    /* Unchecked: White border, Black background */
    lv_obj_set_style_border_color(view->checkbox_true, lv_color_white(), LV_PART_INDICATOR);
    lv_obj_set_style_border_width(view->checkbox_true, 1, LV_PART_INDICATOR);
    lv_obj_set_style_bg_color(view->checkbox_true, lv_color_black(), LV_PART_INDICATOR);
    lv_obj_set_style_bg_opa(view->checkbox_true, LV_OPA_COVER, LV_PART_INDICATOR);
    
    /* Checked: White background, Black checkmark */
    lv_obj_set_style_bg_color(view->checkbox_true, lv_color_white(), LV_PART_INDICATOR | LV_STATE_CHECKED);
    lv_obj_set_style_text_color(view->checkbox_true, lv_color_black(), LV_PART_INDICATOR | LV_STATE_CHECKED);
...
void SetBoolView_Render(SetBoolView_t *view, const SetBool_ViewModelData_t *data)
{
    if (!view || !data)
        return;
